            ...
            try:
                ...
                if start <= check_date <= end:
                    if self.never_on_sundays == "true" and check_date.weekday() == 6:
                        return False
                    if self.never_on_saturdays == "true" and check_date.weekday() == 5:
                        return False
                    return True
            except (ValueError, TypeError):
                pass
...
COMIC_DEFINITIONS = [
    ...
    ComicDefinition(
        name="arctic-circle",
        display_name="Arctic Circle",
        base_url="https://comicskingdom.com/arctic-circle",
        author="Alex Hallatt",
        earliest_date=date(2007, 8, 27),
        info="Arctic Circle – on Comics Kingdom since 2007-08-27."
    ),
    ComicDefinition(
    ...
    ComicDefinition(
        ...
        base_url="https://www.gocomics.com/thebarn",
        author="Ralph Hagen",
        earliest_date=date(2009, 2, 2),
        info="The Barn – on GoComics since 2009/02/02."
    ),    
    ComicDefinition(
    ...
    ComicDefinition(
        name="break-of-day",
        display_name="Break of Day",
        base_url="https://comicskingdom.com/break-of-day",
        author="Nate Fakes",
        earliest_date=date(2023, 4, 1),
        info="Break of Day – on Comics Kingdom since 2023-04-01."
    ),
    ...
    ComicDefinition(
        ...
        base_url="https://comicskingdom.com/edge-city",
        author="Terry & Patty LaBan",
        earliest_date=date(2001, 1, 7),
        weekly_between=("2001-01-07", "2001-02-18"),
        daily_since=date(2001, 2, 19),
        info="On Comics Kingdom, Edge City starts on 2001-01-07 on a weekly base, then becomes daily on 2001-02-19."
    ),    
    ComicDefinition(
        name="family-circus",
   ...
   ComicDefinition(
    ...
    ComicDefinition(
        name="looseparts",
        display_name="Loose Parts",
        base_url="https://www.gocomics.com/looseparts",
        author="Dave Blazek",
        earliest_date=date(2001, 5, 1),
        info="Loose Parts – on GoComics since since 2001-05-01."
    ),    
    ComicDefinition(
        name="luann",
        display_name="Luann",
    ...
    ComicDefinition(
        ...
        display_name="Mother Goose and Grimm | GoComics",
    ...
    ComicDefinition(
        name="grimmy",
        display_name="Mother Goose and Grimm | Grimmy",
        base_url="https://www.grimmy.com",
        author="Mike Peters",
        earliest_date=date(1994, 1, 1),
        info="Mother Goose and Grimm is available on grimmy.com since 1994-01-01.",
        is_custom=True,
        custom_url_pattern="/images/MGG_Archive/MGG_%YYYY%/MGG-%YYYY%-%MM%-%DD%.gif"
    ),
    ComicDefinition(
        name="muttandjeff",
        display_name="Mutt & Jeff",
        base_url="https://www.gocomics.com/muttandjeff",
        author="Bud Fisher",
        earliest_date=date(2003, 1, 6),
        info="Mutt & Jeff – on GoComics since 2003-01-06 (reruns)."
    ),    
    ComicDefinition(
        name="mutts",
        display_name="Mutts",
    ...
    ComicDefinition(
        name="never-been-deader",
        display_name="Never Been Deader",
        base_url="https://comicskingdom.com/never-been-deader",
        author="Tommy Devoid",
        earliest_date=date(2023, 1, 14),
        dates_one_off=("2023-01-14", "2023-01-21"),
        daily_since=date(2023, 8, 13),
        info="On Comics Kingdom, Never Been Deader starts in Jan. 2023 with one-offs on 14 and 21, then daily since 2003-08-13."
    ),    
    ComicDefinition(
        name="nonsequitur",
    ...
    ComicDefinition(
        name="poochcafe",
        display_name="Pooch Café",
        base_url="https://www.gocomics.com/poochcafe",
        author="Paul Gilligan",
        earliest_date=date(2003, 4, 27),
        info="On GoComics, Pooch Café starts with a one-off on 2003-04-27, then daily since 2003-05-04.",
        dates_one_off=("2003-04-27"),
        daily_since=date(2003, 5, 4)
    ),     
    ComicDefinition(
        name="realitycheck",
    ...
    ComicDefinition(
        ...
        base_url="https://comicskingdom.com/safe-havens",
        author="Bill Holbrook",
        earliest_date=date(1999, 6, 28),
        info="Safe Havens – on Comics Kingdom since 1999-06-28 (limited availability)."
    ),        
    ComicDefinition(
        name="sam-and-silo",
        display_name="Sam and Silo",
        base_url="https://comicskingdom.com/sam-and-silo",
        author="Jerry Dumas",
        earliest_date=date(2010, 1, 1),
		never_on_sundays = "true",
        info="Sam and Silo – on Comics Kingdom since 2010-01-01 (extremely limited availability)."
    ),    
    ComicDefinition(
        name="savage-chickens",
        display_name="Savage Chickens",
        base_url="https://www.gocomics.com/savage-chickens",
        author="Doug Savage",
        earliest_date=date(2012, 6, 25),
        never_on_sundays = "true",
        never_on_saturdays = "true",
        info="Savage Chickens – on GoComics since 2012-06-25. These are reruns! The current strips are only on www.savagechickens.com."
    ),    
    ComicDefinition(
        name="scarygary",
        display_name="Scary Gary",
        base_url="https://www.gocomics.com/scarygary",
        author="Mark Buford",
        earliest_date=date(2009, 2, 2),
        info="Scary Gary – on GoComics since 2009-02-02."
    ),    
    ComicDefinition(
        name="shoe",
    ...
    ComicDefinition(
        name="shoe3",
        display_name="Shoe | ShoeComics",
        base_url="https://www.shoecomics.com",
        author="Gary Brookins, Ben Lansing & Susie MacNelly",
        earliest_date=date(2001, 1, 1),
        info="Shoe - on ShoeComics since 2001-01-01.",
        is_custom=True,
    ...
    ComicDefinition(
        name="take-it-from-the-tinkersons",
        display_name="Take it from the Tinkersons",
        base_url="https://comicskingdom.com/take-it-from-the-tinkersons",
        author="Bill Bettwy",
        earliest_date=date(2013, 1, 21),
        dates_one_off=("2013-01-21"),
        daily_since=date(2013, 4, 1),
        info="Take it from the Tinkersons – on Comics Kingdom since 2013-04-01, after a one-off on 2013-01-21."
    ), 
    ComicDefinition(
        name="tiger",
        display_name="Tiger",
        base_url="https://comicskingdom.com/tiger",
        author="Bud Blake",
        earliest_date=date(1996, 1, 7),
        weekly_between=("1996-01-07", "1998-10-04"),
        daily_since=date(1998, 10, 5),
        info="On Comics Kingdom, Tiger starts on 1996-01-07 on a weekly base, then becomes daily on 1998-10-05. Limited availability, but reprints should resurface pre-1996 strips."
    ),    
    ComicDefinition(
        name="tina-s-groove",
    ...
    ComicDefinition(
        name="zackhill",
        display_name="Zack Hill",
        base_url="https://www.gocomics.com/zackhill",
        author="John Deering and John Newcombe",
        earliest_date=date(2003, 1, 1),
        info="Zack Hill – on GoComics since 2003-01-01, with small gaps.",
        skip_ranges=(("2003-01-11", "2003-05-17"), ("2003-05-19", "2003-05-24"))
    ),    
    ComicDefinition(
        name="ziggy",
        display_name="Ziggy",
